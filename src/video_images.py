...
results_path = '../results/csnet/TVSum/fscores/non-overlapping-splits/tvsum_split2_result.h5'
save_path = '../results/csnet/TVSum/fscores/non-overlapping-splits/'
dataset = 'tvsum'
#videos_dir = '../data/SumMe/videos'
videos_dir = '../data/TVSum/videos'
...
def find_summary_segment_medians(summary):
    ...
    for i in idxs:
        if i - prev > 1:
            ...
            medians.append(int(segment[5]))
            medians.append(int(segment[-5]))
            medians.append(int(segment[25]))
            medians.append(int(segment[-25]))
            segment = []
        segment.append(i)
        prev = i
